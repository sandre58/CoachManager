...
using My.CoachManager.Presentation.Wpf.Controls.Schedulers;
...
namespace My.CoachManager.Presentation.Wpf.Controls
{
    ...
    public sealed class SchedulerPanel : Control
    {
        ...
        public static string ToDecadeRangeString(int decade, FrameworkElement fe)
        {
            ...
            DateTimeFormatInfo format = DateTimeHelper.GetDateFormat(DateTimeHelper.GetCulture());
        ...
        private void SetDecadeModeHeaderButton(int decade)
        {
            if (HeaderButton != null)
            {
                HeaderButton.Content = ToDecadeRangeString(decade, this);
