...
namespace My.CoachManager.Presentation.Wpf.Controls.DragAndDrop
{
    /// <summary>
    ...
    public sealed class DragCommand
    {
        ...
        private static void OnDragEnter(object sender, DragEventArgs e)
        {
            ...
            else
            {
                ...
                var target = uiElement.DataContext;

                if ((command == null) || !command.CanExecute(new DragAndDropEventArgs(data, target)))
                {
                    e.Effects = DragDropEffects.None;
                    SetIsDragOver(uiElement, false);
                }
        ...
        private static void OnDrop(object sender, DragEventArgs e)
        {
            ...
            if (e.Data.GetDataPresent(format))
            {
                ...
                if (command.CanExecute(new DragAndDropEventArgs(data, target)))
                {
                    command.Execute(new DragAndDropEventArgs(data, target));
                }
            }
