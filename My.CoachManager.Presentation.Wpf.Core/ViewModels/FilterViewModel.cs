...
namespace My.CoachManager.Presentation.Wpf.Core.ViewModels
{
    ...
    public class FilterViewModel : ModelBase, IFilterViewModel, ISerializable
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="FilterViewModel"/>.
        /// </summary>
        public FilterViewModel(IFilter filter, string title, LogicalOperator logicalOperator = LogicalOperator.And, bool operatorIsVisible = true)
        {
        ...
        /// <summary>
        /// Gets or sets operator is visible;
        /// </summary>
