...
namespace My.CoachManager.Presentation.Wpf.Core.Services
{
    ...
    public interface IDialogService
    {
        ...
        void ShowWorkspaceDialog(IWorkspaceDialogViewModel view, Action<IWorkspaceDialog> callback = null);
        ...
        /// <param name="view">The view to include in workspace dialog.</param>
        /// <param name="title">Title of window.</param>
        DialogResult ShowCustomDialog(IDialogViewModel view, string title);
