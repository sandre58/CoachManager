...
namespace My.CoachManager.Application.Services.Administration
{
    /// <summary>
    ...
    public class PlayerAppService : AppService, IPlayerAppService
    {
        ...
        public PlayerAppService(ILogger logger, IPlayerRepository playerRepository, ICountryRepository countryRepository, ICategoryRepository categoryRepository, IPlayerDomainService playerDomainService, IAddressRepository adressRepository) : base(logger)
        {
        ...
        {
            return _adressRepository.GetByFilter(AdminSelectBuilder.SelectCity(), x => !string.IsNullOrEmpty(x.City), x => x.City, true).Distinct().ToArray();
        }
