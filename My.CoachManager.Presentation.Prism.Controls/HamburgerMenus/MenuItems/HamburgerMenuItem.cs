...
namespace My.CoachManager.Presentation.Prism.Controls.HamburgerMenus.MenuItems
{
    ...
    public class HamburgerMenuItem : Freezable, ICommandSource
    {
        ...
        /// </summary>
        public static readonly DependencyProperty CommandProperty = DependencyProperty.Register(nameof(Command), typeof(ICommand), typeof(HamburgerMenuItem), new PropertyMetadata(null, OnCommandChanged));
