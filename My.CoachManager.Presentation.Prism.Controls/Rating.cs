...
using My.CoachManager.Presentation.Prism.Controls.Ratings;
...
namespace My.CoachManager.Presentation.Prism.Controls {
    ...
    public class Rating : ItemsControl, IUpdateVisualState {
        ...
        protected virtual void OnValueChanged(double? oldValue, double? newValue) {
            ...
            handler?.Invoke(this, new RoutedPropertyChangedEventArgs<double?>(oldValue, newValue));
        }
        ...
        private void UpdateValues() {
            ...
            if (!Equals(oldSelectedItem, newSelectedItem)) {
        ...
        private void UpdateDisplayValues() {
            ...
            RatingItem selectedItem;
            var andWeights = itemAndWeights as Tuple<RatingItem, double>[] ?? itemAndWeights.ToArray();
            Tuple<RatingItem, double> selectedItemAndWeight = andWeights.LastOrDefault(i => i.Item2 > 0.0);
            ...
            foreach (Tuple<RatingItem, double> itemAndWeight in andWeights) {
                if (SelectionMode == RatingSelectionMode.Individual && !Equals(itemAndWeight.Item1, selectedItem)) {
        ...
        private void UpdateHoverStates() {
            ...
            else
            {
                ...
                foreach (RatingItem item in GetRatingItems())
                {
                    IUpdateVisualState updateVisualState = item;
                    updateVisualState?.UpdateVisualState(true);
                }
            }
        }
        ...
        protected override void ClearContainerForItemOverride(DependencyObject element, object item) {
            ...
            if (Equals(ratingItem, HoveredRatingItem)) {
...
#else
#endif
                        if (Application.Current.MainWindow != null && FocusManager.GetFocusedElement(Application.Current.MainWindow) is RatingItem ratingItem) {
