...
namespace My.CoachManager.Presentation.Prism.Controls.Parameters.Commands.Internal
{
    /// <summary>
    ...
    internal static class EventHandlerGenerator
    {
        ...
        /// </returns>
        /// <exception cref="System.ApplicationException">Delegate has a return type. This only supports event handlers that are void</exception>
        public static Delegate CreateDelegate(Type eventHandlerType, MethodInfo methodToInvoke, object methodInvoker)
        {
            ...
            {
                throw new ApplicationException("Delegate has a return type. This only supports event handlers that are void");
            }
