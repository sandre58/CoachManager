...
namespace My.CoachManager.Presentation.Prism.Controls.Datagrid.Columns
{
    ...
    public class DataGridDateColumn : System.Windows.Controls.DataGridBoundColumn
    {
        ...
        {
            DataGridDateColumn.ElementStyleProperty.OverrideMetadata(typeof(DataGridDateColumn), new FrameworkPropertyMetadata(DefaultElementStyle));
            DataGridDateColumn.EditingElementStyleProperty.OverrideMetadata(typeof(DataGridDateColumn), new FrameworkPropertyMetadata(DefaultEditingElementStyle));
        }
        ...
        {
            this.EditingElementStyle = (Style)Application.Current.FindResource("DataGridDateColumnEditingElementStyle");
            this.ElementStyle = (Style)Application.Current.FindResource("DataGridDateColumnElementStyle");
        }
