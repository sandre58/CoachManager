...
{
    /// <summary>
    /// EventArgs used for the <see cref="Controls.HamburgerMenu"/> ItemClick and OptionsItemClick event.
    /// </summary>
    ...
    /// <summary>
    /// EventArgs used for the <see cref="Controls.HamburgerMenu"/> ItemInvoked event.
    /// </summary>
