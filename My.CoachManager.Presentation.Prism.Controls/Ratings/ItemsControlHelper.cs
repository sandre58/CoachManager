...
namespace My.CoachManager.Presentation.Prism.Controls.Ratings {
    /// <summary>
    ...
    internal sealed class ItemsControlHelper {
        ...
        internal Panel ItemsHost {
            get {
                ...
                if (_itemsHost == null && ItemsControl != null) {
        ...
        internal ScrollViewer ScrollHost {
            get {
                if (_scrollHost == null) {
                    ...
                    if (itemsHost != null) {
                        for (DependencyObject obj = itemsHost; !Equals(obj, ItemsControl) && obj != null; obj = VisualTreeHelper.GetParent(obj)) {
        ...
        internal void UpdateItemContainerStyle(Style itemContainerStyle) {
            ...
            foreach (UIElement element in itemsHost.Children) {
                if (element is FrameworkElement obj && obj.Style == null) {
