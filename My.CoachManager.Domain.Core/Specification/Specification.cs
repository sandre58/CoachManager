// -----------------------------------------------------------------------
// <copyright file="Specification.cs" company="Servicarte">
...
namespace My.CoachManager.Domain.Core.Specification
{
         ...
         where TEntity : class
    {
        ...
        /// <param name="rightSideSpecification">Right operand in this AND operation.</param>
        /// <returns>New specification.</returns>
        public Specification<TEntity> BitwiseAnd(Specification<TEntity> leftSideSpecification, Specification<TEntity> rightSideSpecification)
        {
            return new AndSpecification<TEntity>(leftSideSpecification, rightSideSpecification);
        }
        ...
        /// <param name="rightSideSpecification">Right operand in this OR operation.</param>
        /// <returns>New specification.</returns>
        public Specification<TEntity> BitwiseOr(Specification<TEntity> leftSideSpecification, Specification<TEntity> rightSideSpecification)
        {
            return new OrSpecification<TEntity>(leftSideSpecification, rightSideSpecification);
        }
