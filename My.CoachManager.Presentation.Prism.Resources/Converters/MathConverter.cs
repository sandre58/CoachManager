...
namespace My.CoachManager.Presentation.Prism.Resources.Converters
{
    ...
    public sealed class MathAddConverter : MarkupMultiConverter
    {
        ...
        private readonly MathConverter _theMathConverter = new MathConverter() { Operation = MathOperation.Add };
        ...
        {
            return _theMathConverter.Convert(values, targetType, parameter, culture);
        }

        public override object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return _theMathConverter.Convert(value, targetType, parameter, culture);
        }

        public override object[] ConvertBack(object value, Type[] targetTypes, object parameter, CultureInfo culture)
        {
            return _theMathConverter.ConvertBack(value, targetTypes, parameter, culture);
        }

        public override object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return _theMathConverter.ConvertBack(value, targetType, parameter, culture);
        }
    ...
    public sealed class MathSubtractConverter : MarkupMultiConverter
    {
        ...
        private readonly MathConverter _theMathConverter = new MathConverter() { Operation = MathOperation.Subtract };
    ...
    public sealed class MathMultiplyConverter : MarkupMultiConverter
    {
        ...
        private readonly MathConverter _theMathConverter = new MathConverter() { Operation = MathOperation.Multiply };
    ...
    public sealed class MathDivideConverter : MarkupMultiConverter
    {
        ...
        private readonly MathConverter _theMathConverter = new MathConverter() { Operation = MathOperation.Divide };
