...
using My.CoachManager.Presentation.Uwp.Tests.Services;
using My.CoachManager.Presentation.Uwp.Tests.Views;
...
namespace My.CoachManager.Presentation.Uwp.Tests
{
    ...
    public sealed partial class App : PrismUnityApplication
    {
        ...
        protected override async Task OnInitializeAsync(IActivatedEventArgs args)
        {
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "My.CoachManager.Presentation.Uwp.Tests.ViewModels.{0}ViewModel, My.CoachManager.Presentation.Uwp.Tests", viewType.Name.Substring(0, viewType.Name.Length - 4));
