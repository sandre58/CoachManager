...
namespace My.CoachManager.Presentation.Core.Manager
{
    ...
    public static class NavigationManager
    {
        ...
        /// </summary>
        public static ICommand NavigateCommand => new DelegateCommand<string>(s => Navigate(s));
        ...
        /// <param name="paramKey">The parameter key.</param>
        /// <param name="callback">Action when navigation is completed.</param>
        public static void NavigateTo<TView>(object paramValue = null, string paramKey = ParametersConstants.Id, Action<NavigationResult> callback = null)
        {
