...
namespace My.CoachManager.Presentation.Controls.Datagrids.Columns
{
    ...
    public class DataGridDateTimeColumn : DataGridBoundColumn
    {
        ...
        {
            ElementStyleProperty.OverrideMetadata(typeof(DataGridDateTimeColumn), new FrameworkPropertyMetadata(DefaultElementStyle));
            EditingElementStyleProperty.OverrideMetadata(typeof(DataGridDateTimeColumn), new FrameworkPropertyMetadata(DefaultEditingElementStyle));
        }
        ...
        {
            EditingElementStyle = (Style)Application.Current.FindResource("DataGridDateTimeColumnEditingElementStyle");
            ElementStyle = (Style)Application.Current.FindResource("DataGridDateTimeColumnElementStyle");
        }
