...
using My.CoachManager.Presentation.Controls.Parameters.Commands.Internal;

namespace My.CoachManager.Presentation.Controls.Parameters.Commands
{
    /// <summary>
    ...
    public partial class EventCommand
    {
        ...
        public static CommandBindingCollection GetCommandBindings(DependencyObject d)
        {
            ...
            if (!(d.GetValue(CommandBindingsProperty) is CommandBindingCollection collection))
            {
                collection = new CommandBindingCollection { Owner = d };
