...
namespace My.CoachManager.Presentation.Prism.Tests
{
                                                                                                  ...
                                                                                                  IDictionary<TKey, TValue>, IDictionary
    {
        ...
        public virtual void Add(TKey key, TValue value)
        {
            if (ContainsKey(key))
            {
                throw new ArgumentException(@"KeyAlreadyPresent", "key");
            }
            else
            {
                this[key] = value;
        ...
        public virtual TValue this[TKey key]
        {
            ...
            set
            {
                throw new NotImplementedException("MustOverrideIndexerSet");
            }
        }
        ...
        /// if it isn't.
        /// </summary>
        /// <typeparam name="TExpectedType">Expected type of the parameter</typeparam>
        /// <param name="value">parameter value</param>
        private void CheckGenericType<TExpectedType>(object value)
        {
            if (!(value is TExpectedType))
        ...
        {
            CheckGenericType<TKey>(key);
            CheckGenericType<TValue>(value);
        ...
        private sealed class KeysCollection : ReadOnlyCollectionBase<TKey>
        {
            ...
            {
                return key != null && myDictionary.ContainsKey(key);
            }
        }
        ...
        private class DictionaryEnumeratorWrapper : IDictionaryEnumerator
        {
            ...
            public void Reset()
            {
                throw new NotSupportedException("ResetNotSupported");
            }
