    ...
    public struct Pair<TFirst, TSecond> : IComparable, IComparable<Pair<TFirst, TSecond>>
    {
        ...
        public int CompareTo(Pair<TFirst, TSecond> other)
        {
            ...
            catch (ArgumentException)
            {
                ...
                {
                    throw new NotSupportedException("UncomparableType");
                }
        ...
        /// than zero indicates this pair is less than <paramref>
        ///         <name>other</name>
        ///     </paramref>
        ///     . Zero indicate this pair is
        ...
        int IComparable.CompareTo(object obj)
        {
            if (obj is Pair<TFirst, TSecond>)
                ...
                throw new ArgumentException(@"BadComparandType", "obj");
        }
