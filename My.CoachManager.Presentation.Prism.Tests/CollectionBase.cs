...
namespace My.CoachManager.Presentation.Prism.Tests
{
    ...
    public abstract class CollectionBase<T> : ICollection<T>, ICollection
    {
        ...
        {
            return CollectionHelper.ToString(this);
        }
        ...
        public virtual void CopyTo(T[] array, int arrayIndex)
        {
            ...
            if (count < 0)
                throw new ArgumentOutOfRangeException($"count", count, @"ArgMustNotBeNegative");
            if (arrayIndex < 0)
                throw new ArgumentOutOfRangeException($"arrayIndex", arrayIndex, @"ArgMustNotBeNegative");
            if (arrayIndex >= array.Length || count > array.Length - arrayIndex)
                throw new ArgumentException(@"arrayIndex", $"array");
        ...
        public virtual bool Exists(Predicate<T> predicate)
        {
            ...
            return CollectionHelper.Exists(this, predicate);
        }
        ...
        public virtual bool TrueForAll(Predicate<T> predicate)
        {
            ...
            return CollectionHelper.TrueForAll(this, predicate);
        }
        ...
        public virtual int CountWhere(Predicate<T> predicate)
        {
            ...
            return CollectionHelper.CountWhere(this, predicate);
        }
        ...
        public virtual IEnumerable<T> FindAll(Predicate<T> predicate)
        {
            ...
            return CollectionHelper.FindWhere(this, predicate);
        }
        ...
        public virtual ICollection<T> RemoveAll(Predicate<T> predicate)
        {
            ...
            return CollectionHelper.RemoveWhere(this, predicate);
        }
        ...
        public virtual IEnumerable<TOutput> ConvertAll<TOutput>(Converter<T, TOutput> converter)
        {
            ...
            return CollectionHelper.Convert(this, converter);
        }
