...
namespace My.CoachManager.Presentation.Prism.Tests
{
    ...
    public abstract class ListBase<T> : CollectionBase<T>, IList<T>, IList
    {
        ...
        {
            return CollectionHelper.ReadOnly(this);
        }
        ...
        {
            return CollectionHelper.FindFirstWhere(this, predicate);
        }
        ...
        {
            return CollectionHelper.TryFindFirstWhere(this, predicate, out foundItem);
        }
        ...
        {
            return CollectionHelper.FindLastWhere(this, predicate);
        }
        ...
        {
            return CollectionHelper.TryFindLastWhere(this, predicate, out foundItem);
        }
        ...
        {
            return CollectionHelper.FindFirstIndexWhere(this, predicate);
        }
        ...
        {
            int foundIndex = CollectionHelper.FindFirstIndexWhere(Range(index, Count - index), predicate);
            if (foundIndex < 0)
                return -1;
            else
        ...
        {
            int foundIndex = CollectionHelper.FindFirstIndexWhere(Range(index, count), predicate);
            if (foundIndex < 0)
                return -1;
            else
                return foundIndex + index;
        ...
        {
            return CollectionHelper.FindLastIndexWhere(this, predicate);
        }
        ...
        {
            return CollectionHelper.FindLastIndexWhere(Range(0, index + 1), predicate);
        }
        ...
        {
            int foundIndex = CollectionHelper.FindLastIndexWhere(Range(index - count + 1, count), predicate);
        ...
        {
            return CollectionHelper.FirstIndexOf(this, item, EqualityComparer<T>.Default);
        }
        ...
        {
            int foundIndex = CollectionHelper.FirstIndexOf(Range(index, Count - index), item, EqualityComparer<T>.Default);
        ...
        {
            int foundIndex = CollectionHelper.FirstIndexOf(Range(index, count), item, EqualityComparer<T>.Default);
        ...
        {
            return CollectionHelper.LastIndexOf(this, item, EqualityComparer<T>.Default);
        }
        ...
        {
            int foundIndex = CollectionHelper.LastIndexOf(Range(0, index + 1), item, EqualityComparer<T>.Default);
        ...
        {
            int foundIndex = CollectionHelper.LastIndexOf(Range(index - count + 1, count), item, EqualityComparer<T>.Default);
        ...
        /// <code>CollectionHelper.ReverseInPlace(deque.Range(3, 6))</code>
        ...
        {
            return CollectionHelper.Range(this, start, count);
        }
        ...
        private T ConvertToItemType(object value)
        {
            ...
            {
                throw new ArgumentException("ConvertToItemType");
            }
        }
        ...
        {
            int count = Count;
            Insert(count, ConvertToItemType(value));
            return count;
        }
        ...
        {
            Insert(index, ConvertToItemType(value));
        }
        ...
        object IList.this[int index]
        {
            ...
            set
            {
                this[index] = ConvertToItemType(value);
            }
        }
    }
}